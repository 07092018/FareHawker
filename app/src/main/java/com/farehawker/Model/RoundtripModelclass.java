...
public class RoundtripModelclass
{
    ...
    public void setNumberneway(String numberneway) {
        this.numberneway = numberneway;
    }
    public String getOrigintimeneway() {
        return origintimeneway;
    }
    ...
    public void setCalculationneway(String calculationneway) {
        this.calculationneway = calculationneway;
    }
    public int getImgageoneway() {
        return imgageoneway;
    }
    public void setResultindex_oneward(String resultindex_oneward) {
        this.resultindex_oneward = resultindex_oneward;
    }
    public String getResultindex_oneward() {
        return resultindex_oneward;
    }
}
