...
public class International_Roundtrip extends AppCompatActivity {
    ...
    RoundtripOriginAdaptor roundtripOriginAdaptor;
    RoundtripReturnAdaptor roundtripReturnAdaptor;
    List<RoundtripModelclass> roundtripModelclassList = new ArrayList<RoundtripModelclass>();
    List<RoundtripreturnModelclass> roundTripReturnModelclassList = new ArrayList<RoundtripreturnModelclass>();
    RecyclerView recyclerViewL, recyvlerViewR;
    ...
    String airlineCode;
    TextView NoOfSeatsAvailableT, StopPointT, airlineT, airlineNameT, airlineCodeT, flightCodeT, originT, destinationT, deptimeT, arrTimeT;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_international__roundtrip);
        findViewById(R.id.originAirports);
        intent = getIntent();
            ...
            * {"EndUserIp":"216.10.251.69","TokenId":"51e12095-4692-40fe-9540-fc5ebe621008","AdultCount":"1","ChildCount":"0","InfantCount":"0","DirectFlight":"false","OneStopFlight":"false","JourneyType":"1","Segments":[{"Origin":"DEL","Destination":"DXB","FlightCabinClass":"1","PreferredDepartureTime":"2018-08-22T00:00:00"}]}*/
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, URL, jsonObject, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    ...
                    lefta = new RoundtripOriginAdaptor(International_Roundtrip.this, roundleftlist);
